      ...
      <main className="flex-1 bg-background p-8 text-foreground md:p-12 lg:p-16">
        <section className="mb-8">
          ...
          <p className="text-muted-foreground">
            ...
            web development. Proficient in JavaScript, React, Node.js, and
            various web technologies. Passionate about building scalable and
            user-friendly applications. Committed to staying up-to-date with the
            ...
            <div>
              ...
              <ul className="mt-2 list-disc pl-4 text-muted-foreground">
                <li>
                  ...
                  Node.js, and various supporting technologies.
                </li>
                <li>
                ...
                <li>
                  ...
                  processes to ensure high-quality and reliable software.
                </li>
              </ul>
            </div>
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                XYZ Corp. | Jun 2019 - Dec 2019
              </p>
              <ul className="mt-2 list-disc pl-4 text-muted-foreground">
                <li>
                  Contributed to the development of a responsive e-commerce
                  website using HTML, CSS, and JavaScript.
                </li>
                <li>
                  Assisted in implementing new features and fixing bugs in the
                  existing codebase.
                </li>
                <li>
                  Gained experience in working with version control systems and
        ...
        <section className="mb-8">
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Graduated with a GPA of 3.8 and received the Deans List
